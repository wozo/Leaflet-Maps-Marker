...
(function($) {
  ...
  <?php }; ?>
  marker = new L.Marker(new L.LatLng(<?php echo $lat . ", " . $lon; ?>),{ <?php if ($lmm_options[ 'defaults_marker_icon_title' ] == 'show') { echo "title: '$markername', "; }; ?> opacity: <?php echo intval($lmm_options[ 'defaults_marker_icon_opacity' ]) ?>});
  <?php if ($icon == NULL) { 
