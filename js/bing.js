...
*/
L.BingLayerAerial = L.TileLayer.extend({
	options: {
		subdomains: [0, 1, 2, 3],
		attribution: 'Bing'
	},
...
/* AerialWithLabels */
L.BingLayerAerialWithLabels = L.TileLayer.extend({
	options: {
		subdomains: [0, 1, 2, 3],
		attribution: 'Bing'
	},
...
/* Road */
L.BingLayerRoad = L.TileLayer.extend({
	options: {
		subdomains: [0, 1, 2, 3],
		attribution: 'Bing'
	},
