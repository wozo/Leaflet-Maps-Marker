<?php  
	...
	if (isset($lmm_options[ 'overlays_custom' ] ) == TRUE ) {
	...
	if (isset($lmm_options[ 'overlays_custom2' ] ) == TRUE ) {
	...
	if (isset($lmm_options[ 'overlays_custom3' ] ) == TRUE ) {
	...
	if (isset($lmm_options[ 'overlays_custom4' ] ) == TRUE ) {
