...
class Class_leaflet_options {
	...
	public function __construct() {
		...
		$this->panes['defaults_marker']	= __('Marker/Icon/Popup defaults','lmm');
		$this->panes['defaults_layer']	= __('Layer defaults','lmm');
		$this->panes['google']			= __('Google','lmm');
		...
		$this->sections['basemaps-section1']		= __('Basemaps Section 1','lmm');
		$this->sections['basemaps-section2']		= __('Basemaps Section 2','lmm');
        $this->sections['basemaps-section3']        = __('Basemaps Section 3','lmm');
        $this->sections['basemaps-section4']        = __('Basemaps Section 4','lmm');
        $this->sections['basemaps-section5']        = __('Basemaps Section 5','lmm');//no options available yet for this section
		$this->sections['overlays-section1']		= __('Overlays Section 1','lmm');
		$this->sections['overlays-section2']		= __('Overlays Section 2','lmm');//no options available yet for this section
		$this->sections['wms-sections1']			= __('WMS Section 1 ','lmm');
		$this->sections['defaults_marker-section1']	= __('Marker/Icon/Popup defaults Section 1','lmm');
		$this->sections['defaults_layer-section1']	= __('Layer defaults Section 1 ','lmm');
		$this->sections['google-section1']			= __('Google Section 1 ','lmm');
		$this->sections['directions-section1']		= __('Directions','lmm');
		$this->sections['ar-section1']				= __('AR Section 1','lmm');
		$this->sections['misc-section1']			= __('Misc Section 1','lmm');
		$this->sections['reset-section1']			= __('Reset Section 1 ','lmm');
	...
	public function display_basemaps_section() {
		echo '<span class="leafletmapsmarker-listings"><p><strong>' . __('Index','lmm') . '</strong></p><ul style="list-style-type:disc;padding-left:50px;">
	...
	public function get_settings() {
		...
		*/
		$this->settings['defaults_layer_heading'] = array(
			'version' => '1.0',
			'pane'    => 'defaults_layer',
			'section' => 'defaults_layer-section1',
			'title'   => '', 
	...
	*/
	...
	public function register_settings() {
        ...
        foreach ( $this->sections as $slugs => $titles ) {
            if ( $slugs == 'basemaps-section1' )
                add_settings_section( $slugs, $titles, array( &$this, 'display_basemaps_section' ), 'leafletmapsmarker_settings' );
            else if ( $slugs == 'basemaps-section2' )
                add_settings_section( $slugs, $titles, array( &$this, 'display_basemaps_section' ), 'leafletmapsmarker_settings' );
            else if ( $slugs == 'overlays-section1' )
                add_settings_section( $slugs, $titles, array( &$this, 'display_overlays_section' ), 'leafletmapsmarker_settings' );
            else if ( $slugs == 'overlays-section2' )
                add_settings_section( $slugs, $titles, array( &$this, 'display_overlays_section' ), 'leafletmapsmarker_settings' );
            else if ( $slugs == 'wms-sections1' )
                add_settings_section( $slugs, $titles, array( &$this, 'display_wms_section' ), 'leafletmapsmarker_settings' );
            else if ( $slugs == 'defaults_marker-section1' )
                add_settings_section( $slugs, $titles, array( &$this, 'display_defaults_marker_section' ), 'leafletmapsmarker_settings' );
            else if ( $slugs == 'defaults_layer-section1' )
                add_settings_section( $slugs, $titles, array( &$this, 'display_defaults_layer_section' ), 'leafletmapsmarker_settings' );
            else if ( $slugs == 'google-section1' )
                add_settings_section( $slugs, $titles, array( &$this, 'display_google_section' ), 'leafletmapsmarker_settings' );
            else if ( $slugs == 'directions-section1' )
                add_settings_section( $slugs, $titles, array( &$this, 'display_directions_section' ), 'leafletmapsmarker_settings' );
            else if ( $slugs == 'misc-section1' )
                add_settings_section( $slugs, $titles, array( &$this, 'display_misc_section' ), 'leafletmapsmarker_settings' );
            else
                add_settings_section( $slugs, $titles, array( &$this, 'display_section' ), 'leafletmapsmarker_settings' );
        } 
