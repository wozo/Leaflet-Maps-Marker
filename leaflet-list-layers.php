...
'<td>' . $openpanelstatus . '</td>' : '';
		 ...
		 $column_shortcode = ((isset($lmm_options[ 'misc_layer_listing_columns_shortcode' ] ) == TRUE ) && ( $lmm_options[ 'misc_layer_listing_columns_shortcode' ] == 1 )) ? '<td><input onfocus="this.select()" style="width:170px;background:#f3efef;" type="text" value="[' . $lmm_options[ 'shortcode' ] . ' layer=&quot;' . $row['id'] . '&quot;]" readonly></td>' : '';
