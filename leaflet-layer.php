		...
		<table class="widefat fixed">
			...
			<tr>
				...
				<td>
					...
					echo '<br/><br/><input type="checkbox" id="mlm-all" name="mlm-all" ' . $mlm_checked_all . '> ' . __('display all markers','lmm') . '<br/><br/><strong>' . __('Display selected layers only','lmm') . '</strong><br/>';
					foreach ($layerlist as $mlmrow){
