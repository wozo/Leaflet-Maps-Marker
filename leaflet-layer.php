...
$layerlist = $wpdb->get_results('SELECT l.id as lid,l.name as lname FROM '.$table_name_layers.' as l', ARRAY_A);
		...
		<table class="widefat fixed">
			...
			<tr>
				...
				<td>
					...
					_e('Please select the layers, whose markers you would like to display on this multi layer map. Please note that markers cannot be added to a multi layer map directly. ','lmm').PHP_EOL;
					echo '<br/><br/><input type="checkbox" id="mlm-all" name="mlm-all"> ' . __('display all markers','lmm') . '<br/><br/><strong>' . __('Display selected layers only','lmm') . '</strong><br/>';
					foreach ($layerlist as $mlmrow){
						...
						if ( $multi_layer_map_list == $mlmrow['lid'] ) { 
...
/* //<![CDATA[ */
var marker,selectlayer,osm_mapnik,osm_osmarender,mapquest_osm,mapquest_aerial,ogdwien_basemap,ogdwien_satellite,cloudmade,cloudmade2,cloudmade3,custom_basemap,custom_basemap2,custom_basemap3,overlays_custom,overlays_custom2,overlays_custom3,overlays_custom4,wms,wms2,wms3,wms4,wms5,wms6,wms7,wms8,wms9,wms10,layersControl;
var markers = {};
(function($) {
